...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annotation.cluster'
        db.delete_column(u'pdf_layer_annotation', 'cluster_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Annotation.cluster'
        raise RuntimeError("Cannot reverse this migration. 'Annotation.cluster' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Annotation.cluster'
        db.add_column(u'pdf_layer_annotation', 'cluster',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pdf_layer.Publication']),
                      keep_default=False)
