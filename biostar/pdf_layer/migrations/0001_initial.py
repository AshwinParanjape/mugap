...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pdf_layer_publication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cluster_id', self.gf('django.db.models.fields.TextField')(max_length=50)),
            ('excerpt', self.gf('django.db.models.fields.TextField')(null=True)),
            ('num_citations', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('num_versions', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('title', self.gf('django.db.models.fields.TextField')(null=True)),
            ('url', self.gf('django.db.models.fields.TextField')(null=True)),
            ('url_citations', self.gf('django.db.models.fields.TextField')(null=True)),
            ('url_pdf', self.gf('django.db.models.fields.TextField')()),
            ('url_versions', self.gf('django.db.models.fields.TextField')(null=True)),
        ...
        db.send_create_signal(u'pdf_layer', ['Publication'])

        # Adding model 'Annotation'
        db.create_table(u'pdf_layer_annotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pdf_layer.Publication'])),
            ...
            ('seralized_version', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'pdf_layer', ['Annotation'])


    def backwards(self, orm):
        # Deleting model 'Publication'
        db.delete_table(u'pdf_layer_publication')

        # Deleting model 'Annotation'
        db.delete_table(u'pdf_layer_annotation')
    ...
    models = {
        ...
        u'pdf_layer.publication': {
            ...
            'cluster_id': ('django.db.models.fields.TextField', [], {'max_length': '50'}),
