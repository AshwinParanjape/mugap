...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.id'
        db.delete_column(u'pdf_layer_publication', u'id')


        # Changing field 'Publication.cluster_id'
        db.alter_column(u'pdf_layer_publication', 'cluster_id', self.gf('django.db.models.fields.TextField')(max_length=50, primary_key=True))

    def backwards(self, orm):
        # Adding field 'Publication.id'
        db.add_column(u'pdf_layer_publication', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=-1, primary_key=True),
                      keep_default=False)


        # Changing field 'Publication.cluster_id'
        db.alter_column(u'pdf_layer_publication', 'cluster_id', self.gf('django.db.models.fields.TextField')(max_length=50, unique=True))
