...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annotation.seralized_version'
        db.delete_column(u'pdf_layer_annotation', 'seralized_version')

        # Adding field 'Annotation.page_num'
        db.add_column(u'pdf_layer_annotation', 'page_num',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Annotation.serialized_version'
        db.add_column(u'pdf_layer_annotation', 'serialized_version',
                      self.gf('django.db.models.fields.TextField')(default='type:textContent'),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Annotation.seralized_version'
        raise RuntimeError("Cannot reverse this migration. 'Annotation.seralized_version' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Annotation.seralized_version'
        db.add_column(u'pdf_layer_annotation', 'seralized_version',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'Annotation.page_num'
        db.delete_column(u'pdf_layer_annotation', 'page_num')

        # Deleting field 'Annotation.serialized_version'
        db.delete_column(u'pdf_layer_annotation', 'serialized_version')
    ...
    models = {
        ...
        u'pdf_layer.publication': {
            ...
            'cluster_id': ('django.db.models.fields.TextField', [], {'max_length': '50', 'primary_key': 'True'}),
